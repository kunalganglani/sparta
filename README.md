# 🐝 Sparta <a href="https://www.patreon.com/kunalganglani"><img src="https://c5.patreon.com/external/logo/become_a_patron_button@2x.png" width="100"></a>
...
```sh
git clone git@github.com/kunalganglani/sparta.git && cd sparta
```
...
### Apps
# Search apps here https://theappstore.org/search.php?search=rectangle&platform=macSoftware for app name and id
<details>
